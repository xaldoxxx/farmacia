...
<p>
  Un sistema web ligero y moderno diseñado para farmacias, que permite gestionar un catálogo de productos y recibir pedidos directamente por <strong>WhatsApp</strong>. Incluye un panel de administración con alertas inteligentes de stock y vencimiento.
</p>
...
<ul>
  <li><strong>Número de WhatsApp:</strong> Cambia <code>NUMERO_WHATSAPP</code> por el tuyo (formato internacional).</li>
...
<ol>
  ...
  <li>Ejecuta la aplicación: <code>python app.py</code></li>
